 ...
 **/
public class ReceiveReceiptInfoApiTest extends AbstractTestNGSpringContextTests {
    ...
    public void testNOProjectList(){
        ...
        openAPiUtils.assertErrorResult(receiveReceipt,method,className,description);
    ...
    public void testAllResut(){
        ...
        openAPiUtils.assertExitResult(receiveReceipt,method,className,description);
    }
