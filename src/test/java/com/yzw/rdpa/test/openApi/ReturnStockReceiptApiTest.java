 ...
 **/
public class ReturnStockReceiptApiTest extends AbstractTestNGSpringContextTests {
    ...
    public void testProjectList(){
        String description = "只传 projectList,期望能够返回该项目对应的值";
        ...
        openAPiUtils.assertExitResult(ReturnStockReceipt,method,className,description);
    ...
    public void testNOProjectList(){
        String description = "必填参数不穿校验，不传projectList, 期望返回错误的编码";
        ReturnStockReceipt ReturnStockReceipt = new ReturnStockReceipt();

        openAPiUtils.assertErrorResult(ReturnStockReceipt,method,className,description);
