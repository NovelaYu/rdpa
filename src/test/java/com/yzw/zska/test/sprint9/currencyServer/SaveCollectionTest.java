...
@Description("根据航道查地区列表")
public class SaveCollectionTest extends AbstractTestNGSpringContextTests {
    ...
    private String url ="https://kongfuzi.longfor.uat/admin-server/v1/rest/organization/getReginListByChannel";
