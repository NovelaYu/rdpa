...
@Description("制度撤回接口")
public class RegulationRevocationTest {
    ...
    private String url = "https://kongfuzi.longfor.uat/system-server/v1/rest/regulation/revocation";
    @BeforeClass
    ...
    @Test
    @Description("传正常值撤回，返回正确结果")
    public void testProjectList() {
        // String description = "只传 projectList";
        String json = "{\"businessId\":1000434}";
