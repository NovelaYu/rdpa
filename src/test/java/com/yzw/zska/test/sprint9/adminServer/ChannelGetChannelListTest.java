...
@Description("查询航道列表接口")
public class ChannelGetChannelListTest {
    ...
    private String url ="https://kongfuzi.longfor.uat/admin-server/v1/rest/channel/getChannelList?r=1629471107470";
