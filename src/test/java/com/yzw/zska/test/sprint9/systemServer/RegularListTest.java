...
public class RegularListTest extends AbstractTestNGSpringContextTests {
    /**生成测试报告**/
    private static ExtentReports extent;
    //private static ExtentTest test;
    private static BaseUtils baseUtils;
    private static String token;
    private String url ="https://kongfuzi.longfor.uat/system-server/v1/rest/regular/list";
    ...
    public void testProjectList() {
        ...
        String json ="{\"channel\":\"C1\",\"fileType\":\"0\",\"funcCodeList\":[],\"regularName\":\"\",\"regionList\":[],\"pageNum\":1,\"pageSize\":99}";
