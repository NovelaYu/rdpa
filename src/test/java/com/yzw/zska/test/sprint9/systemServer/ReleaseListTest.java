...
public class ReleaseListTest {
    ...
    private String url ="https://kongfuzi.longfor.uat/system-server/v1/rest/personal/release/list";
    ...
    public void testProjectList() {
        ...
        String json ="{\"status\":1,\"pageNum\":1,\"pageSize\":99}";
