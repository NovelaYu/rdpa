...
public class UserCurrentTest {
    ...
    private String url = "https://kongfuzi.longfor.uat/admin-server/v1/rest/organization/getDepartmentByPage";
    @BeforeClass
    ...
    @Test
    @Description("传正常值，返回正确结果")
    public void testProjectList() {
        // String description = "只传 projectList";
        String json = "{\"organizationType\":2,\"pageNum\":1,\"pageSize\":999,\"channel\":\"C2\",\"regionCode\":\"6000000023\"}\n";
