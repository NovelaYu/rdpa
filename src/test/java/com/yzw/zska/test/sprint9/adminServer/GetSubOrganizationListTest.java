...
@Description("根据组架编号和新旧组架查询子组架和人员集合接口")
public class GetSubOrganizationListTest {
    ...
    private String url ="https://kongfuzi.longfor.uat/admin-server/v1/rest/organization/getSubOrganizationList?organizationType=2&organizationNo";
