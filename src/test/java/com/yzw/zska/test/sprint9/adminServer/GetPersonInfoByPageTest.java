...
public class GetPersonInfoByPageTest {
    /**生成测试报告**/
    private static ExtentReports extent;
    //private static ExtentTest test;
    private static BaseUtils baseUtils;
    private static String token;
    private String url ="https://kongfuzi.longfor.uat/admin-server/v1/rest/organization/getPersonInfoByPage";
    ...
    public void testProjectList() {
        ...
        String json ="{\"pageNum\":1,\"pageSize\":20,\"keyWords\":\"mao\",\"organizationType\":2}\n";
