...
@Description("查询制度详情")
public class GetBrowseListByBusinessIdTest {
    ...
    private String url ="https://kongfuzi.longfor.uat/system-server/v1/rest/regulation/getDetail";
