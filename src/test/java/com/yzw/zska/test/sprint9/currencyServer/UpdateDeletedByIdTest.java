...
@Description("收藏接口")
public class UpdateDeletedByIdTest extends AbstractTestNGSpringContextTests {
    /**生成测试报告**/
    private static ExtentReports extent;
    //private static ExtentTest test;
    private static BaseUtils baseUtils;
    private static String token;
    private String url ="https://kongfuzi.longfor.uat/currency-server/v1/collection/saveCollection";
    ...
    public void testProjectList() {
        ...
        String json ="{\"businessId\":\"1000408\",\"systemNamespace\":\"system_server\"}\n";
