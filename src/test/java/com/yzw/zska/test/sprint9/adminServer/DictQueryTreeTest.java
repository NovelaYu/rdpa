...
@Description("查询树型数据字典接口")
public class DictQueryTreeTest {
    ...
    private String url ="https://kongfuzi.longfor.uat/admin-server/v1/rest/dict/query/tree?systemNamespace=system_server&typeCode=regulation_type";
