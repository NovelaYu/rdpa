...
@Description("查询制度是否被收藏")
public class CollectionGetListTest {
    /**生成测试报告**/
    private static ExtentReports extent;
    //private static ExtentTest test;
    private static BaseUtils baseUtils;
    private static String token;
    private String url ="https://kongfuzi.longfor.uat/currency-server/v1/collection/isCollection?businessId=1000405&systemNamespace=system_server";
    ...
    @Test
    @Description("航道正常传值，返回正确结果")
    public void testProjectList() {
        // String description = "只传 projectList";
        String json = "{\"pageNum\":1,\"pageSize\":20}";
