...
@Description("获取推荐记录")
public class RecommendGetIdByListTest {
    /**生成测试报告**/
    private static ExtentReports extent;
    private static BaseUtils baseUtils;
    private static String token;
    private String url ="https://kongfuzi.longfor.uat/system-server/v1/rest/recommend/getIdByList";
    ...
    @Test
    @Description("正常获取推荐记录，返回正确结果")
    public void testProjectList() {
        // String description = "只传 projectList";
        String json = "{\"businessId\":\"11373\",\"pageSize\":20,\"pageNum\":1}\n";
