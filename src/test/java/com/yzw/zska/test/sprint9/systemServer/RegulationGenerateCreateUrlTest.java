...
@Description("生成原OA制度链接接口")
public class RegulationGenerateCreateUrlTest {
    /**生成测试报告**/
    private static ExtentReports extent;
    //private static ExtentTest test;
    private static BaseUtils baseUtils;
    private static String token;
    private String url ="https://kongfuzi.longfor.uat/admin-server/v1/rest/regulation/generateCreateUrl";
    ...
    public void testProjectList() {
        ...
        map.put("regulationId","18706");
        map.put("createType","0");
        map.put("regulationType","0");
