package com.yzw.zska.test.sprint9.currencyServer;
...
@Description("保存并提交制度接口")
public class GetPreviewUrlTest {
    /**生成测试报告**/
    private static ExtentReports extent;
    //private static ExtentTest test;
    private static BaseUtils baseUtils;
    private static String token;
    private String url ="https://kongfuzi.longfor.uat/system-server/v1/rest/regulation/save";
    ...
    public void testProjectList() {
        ...
        map.put("systemCode","100001");
        map.put("fileId","1426137774173114368");
        map.put("showAnno","false");
        ...
        try {
            Response response = HttpService.getHttp(map,headersMap,url);
